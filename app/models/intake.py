...
class Intake(Base):
    ...
    dish_id = Column(BigInteger, ForeignKey("dishes.id", ondelete="RESTRICT"), nullable=True)  # Allow null for water intakes
    ...
    # Relationship to get dish details - handle nullable dish_id
