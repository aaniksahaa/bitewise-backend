...
class IntakeBase(BaseModel):
    ...
    dish_id: Optional[int] = Field(default=None, description="ID of the dish consumed. Can be null for water-only intakes")
...
class IntakeCreate(IntakeBase):
    ...
    dish_id: int = Field(..., description="ID of the dish consumed")  # Required for regular intakes
...
class IntakeResponse(IntakeBase):
    ...
    user_id: int
    created_at: datetime
    dish: Optional[DishDetail] = Field(default=None, description="Details of the consumed dish. Null for water-only intakes")
...
class IntakePeriodQuery(BaseModel):
    ...
    end_time: datetime = Field(..., description="Time period")
